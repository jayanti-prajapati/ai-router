/**
 * @ai/router — public API surface
 *
 * Primary usage:
 *   import { runAiRequest } from '@ai/router';
 *
 * Advanced (lower-level building blocks):
 *   import { classify, route, scoreOutput } from '@ai/router';
 *   import type { RunRequest, RunResponse } from '@ai/router';
 *
 * Adding a custom provider:
 *   import { BaseProvider, getProvider } from '@ai/router';
 */
...
export { estimateTokens, computeCost, estimateCost, estimateOutputTokens } from './core/cost.js';
...
// ── Prompt registry ────────────────────────────────────────────────────────
export { getPrompt, render, listPrompts, promptRef } from './prompts/registry.js';
...
// ── Model catalog ──────────────────────────────────────────────────────────
export { MODELS, TIER_ORDER, modelsForTier, getModel, effectiveRate } from './config/models.js';
